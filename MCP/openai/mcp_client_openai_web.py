"""
MCP Client Chatbot with OpenAI Tool Router (Web Transport)
Routes prompts with OpenAI and calls MCP tools over HTTP JSON-RPC.
"""
...
def main():
    ...
    try:
        ...
        print("\nOpenAI-routed web chatbot ready. Type a prompt (or 'tools' / 'exit').")
        while True:
